...
(function($ , undefined) {
    ...
    function AceAjax(contentArea, settings) {
        ...
        this.getUrl = function(url, hash, manual_trigger) {
            ...
            .done(function(result) {
                ...
                if(typeof self.settings.update_breadcrumbs === 'function') {
                    self.settings.update_breadcrumbs.call(null, hash, url, link_element);
                }
                else if(self.settings.update_breadcrumbs === true && link_element != null && link_element.length > 0) {
                    updateBreadcrumbs(link1[2],link_element);
                }
                /////////
        ...
        function updateBreadcrumbs(parent, link_element) {
            var link_text = '';
            //update breadcrumbs
            var breadcrumbs = $('.breadcrumb');
            $('<li class="active">'+parent.toUpperCase()+'</li>').appendTo(breadcrumbs)
