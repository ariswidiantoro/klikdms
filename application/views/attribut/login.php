...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - AxoTirta</title>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo path_css(); ?>ace.css" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="<?php echo path_css(); ?>ace-part2.css" />
        <![endif]-->
        <link rel="stylesheet" href="<?php echo path_css(); ?>ace-rtl.css" />
        ...
        <script src="<?php echo path_js(); ?>respond.js"></script>
        <![endif]-->
    </head>
    ...
    <body class="login-layout">
                        ...
                        <div class="login-container">
                            ...
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="white" id="id-text2">Form</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; klikdms</h4>
                            </div>
                            <?php
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo site_url('welcome/prosesLogin'); ?>" method="post" >
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" name="cbid" required="required" class="form-control" placeholder="Kode Cabang" />
        ...
        <!--[if IE]>
<script type="text/javascript">
window.jQuery || document.write("<script src='<?php echo path_js(); ?>jquery1x.js'>"+"<"+"/script>");
</script>
<![endif]-->
        <script type="text/javascript">
