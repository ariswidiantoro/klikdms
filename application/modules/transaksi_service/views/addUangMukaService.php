...
<form class="form-horizontal" id="formAdd" method="post" action="" name="formAdd">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            ...
            <input type="hidden" id="trans_sub_trans" name="trans_sub_trans" value="<?php echo DEPT_SERVICE; ?>" />
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-left" for="form-field-1">No. Work Order</label>
        <div class="col-sm-6">
            <input type="text" id="dtrans_nota" name="dtrans_nota[]" required="required" maxlength="50" 
                   onkeyup="acomplete('dtrans_nota', 'auto_faktur', 'dtrans_notaid', '','')"class="req upper ace col-xs-10 col-sm-4" />
            <a href="#transaksi_service/workOrder?href=transaksi_sparepart/uangmukaSparepart" class="btn btn-sm btn-primary">
    ...
    <!--<div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="hidden" id="dtrans_coa" name="dtrans_coa[]" value="<?php echo UANGMUKA_SERVICE; ?>" />
...
<script type="text/javascript">
    function redirect(data){
        bootbox.confirm("Anda yakin kembali ?", function(result) {
            if(result) {
                window.location.href = "#transaksi_service/";
            }});
    }
                   ...
                   <td>\n\
                    ...
                    <td class="center" style="vertical-align: middle;">\n\
                        ...
                        function acomplete(id, url, trglocal, trgid, trgname){
                            ...
                            var coa = '<?php echo UANGMUKA_SERVICE?>';
                            $("#" + id).autocomplete({
                                minLength: 1,
