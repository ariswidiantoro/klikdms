    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" id="dtrans_pelname" name="dtrans_pelname" required="required" maxlength="50" 
                   onkeyup="acomplete('dtrans_pelname', 'auto_pelid', 'dtrans_pelid', '','')"class="req upper ace col-xs-10 col-sm-6" />
            <a href="#master_service/addPelanggan?href=transaksi_service/pembayaranPiutang" class="btn btn-sm btn-primary">
                    ...
                    <tr  class="item-row">
                        ...
                        <td>
                            <input type="text" autocomplete ="off" placeholder="NO. NOTA"
                                   onkeyup="acomplete('dtrans_nota1', 'auto_pelid', 'dtrans_notaid1', 'dtrans_tgl1', 'dtrans_tgl1')" 
                        ...
                        <td>
                            <input type="text" class="upper ace col-xs-10 col-sm-10" placeholder="TGL" readonly
                                   style="width:100%;"  name="dtrans_tgl[]" id="dtrans_tgl1" />
                        </td>
                        <td>
                    ...
                    <td class="dtrans center" style="vertical-align:middle;">' + inc + '</td>\n\
                        <td>\n\
                            <input type="text" autocomplete="off" class="upper ace col-xs-10 col-sm-10" style="width:100%;"  \n\
                                onkeyup = "acomplete(\'dtrans_nota'+inc+'\', \'auto_pelid\', \'dtrans_notaid'+inc+'\', \'dtrans_tgl'+inc+'\', \'dtrans_tgl'+inc+'\')"\n\
                                placeholder = "NO. NOTA"\n\
    ...
    function acomplete(id, url, trglocal, trgid, trgname){
        ...
        $("#" + id).autocomplete({
            ...
            create: function () {
                ...
                if($("input[name^=dtrans_notaid]").val() == ui.item.trglocal){
