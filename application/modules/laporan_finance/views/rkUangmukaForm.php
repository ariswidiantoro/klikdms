                ...
                <div>
                    <div class="input-group" style="width:100%;">
                        <select id="coa" name="coa" class="form-control input-small">
                            <option value ="<?php echo UANGMUKA_UNIT ?>">UNIT</option>
                            <option value ="<?php echo UANGMUKA_SERVICE ?>">SERVICE</option>
                            <option value ="<?php echo UANGMUKA_SPART ?>">SPAREPART</option>
                            <option value ="<?php echo UANGMUKA_BREPAIR ?>">BODYREPAIR</option>
                        </select>
                    </div>
                </div>
            </div>
