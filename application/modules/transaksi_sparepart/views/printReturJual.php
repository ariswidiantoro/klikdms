...
<div style="margin:10px">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="2%">:</td>
            <td width="33%"><?php echo $faktur['not_nomer']; ?></td>
            <th width="15%">&nbsp;</th>
            <td width="2%">&nbsp;</td>
            <td width="33%">&nbsp;</td>
        </tr>
        <tr>
            <th width="15%">No. Retur Jual</th>
            <td width="2%">:</td>
            <td width="33%"><?php echo $faktur['rjid']; ?></td>
            <th width="15%">&nbsp;</th>
            <td width="2%">&nbsp;</td>
            <td width="33%">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td width="2%">:</td>
            <td width="33%"><?php echo dateToIndo($faktur['rj_tgl']); ?></td>
        </tr>
        <tr>
            <th width="15%">Nama Pelanggan</th>
            <td width="2%">:</td>
            <td width="33%"><?php echo $faktur['pel_nama']; ?></td>
        </tr>
        <tr>
            <th width="15%">Alasan Retur</th>
            <td width="2%">:</td>
            <td width="33%"><?php echo $faktur['rj_alasan']; ?></td>
        </tr>
        <tr>
            <td colspan="6">
                <table id="table-detail" >
                    ...
                    foreach ($barang as $value) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;"><?php echo $value['det_qty']; ?></td>
                            <td style="text-align: right;"><?php echo number_format($value['det_harga']); ?></td>
                            <td style="text-align: right;"><?php echo $value['det_diskon']; ?></td>
                            <td style="text-align: right;"><?php echo number_format($value['det_subtotal']); ?></td>
                        </tr>
                        <?php
                        $no++;
                    }
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            <?php echo number_format($faktur['rj_total']); ?>
                        </td>
                    </tr>
                </table>
            </td>
