        ...
        <form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url('transaksi_prospect/saveFpt'); ?>" name="formAdd">
                        ...
                        <table id="simple-table-aksesories" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr  class="item-row">
                                    ...
                                    <td>
                                        <input type="text" id="dtrans_harga1" onchange="$('#'+this.id).val(formatDefault(this.value));totalAccesories();" name="dtrans_harga[]"  placeholder="HARGA" class="form-control number upper hargaaccs" />
                                    </td>
            ...
            <div class="step-pane" data-step="4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group col-sm-6">
                            <input type="text" name="fpt_accesories" id="fpt_accesories" style="text-align: right;" value="0" onchange="$('#'+this.id).val(formatDefault(this.value));" onkeyup="total()" class="form-control harga number upper" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        $(".item-row:last").after('<tr  class="item-row">\n\
            ...
            <td>\n\
                    <input type="text" id="dtrans_harga'+(inc)+'" onchange="$(\'#\'+this.id).val(formatDefault(this.value));totalAccesories();" name="dtrans_harga[]"  placeholder="HARGA" class="form-control number upper hargaaccs" />\n\
            </td>\n\
            <td class="center" style="vertical-align: middle;">\n\
                <a class="green btnAdd"  onclick="addRow()" href="javascript:;"><i class="ace-icon fa fa-plus bigger-130"></i></a>\n\
            </td>\n\
                    ...
                    $('#formAdd').submit(function() {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if(data.result)
                                {
                                    $('.page-content-area').ace_ajax('loadUrl', "#transaksi_prospect/addFpt?id="+$("#fpt_prosid").val(), true);
                                }else
                                {
