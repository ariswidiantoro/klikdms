...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url('master_finance/saveCostCenter'); ?>" name="formAdd">
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Kode Cost Center</label>
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="30" style='text-transform:uppercase' 
...
<script type="text/javascript">
    ...
    $(this).ready(function() {
        ...
        $('#formAdd').submit(function() {
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('master_finance/saveCostCenter') ?>",
                dataType: "json",
                async: false,
                data: $(this).serialize(),
