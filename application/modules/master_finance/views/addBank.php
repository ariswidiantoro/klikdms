...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url('master_finance/saveBank'); ?>" name="formAdd">
...
<script type="text/javascript">
    ...
    $(this).ready(function() {
        ...
        $('#formAdd').submit(function() {
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('master_finance/saveBank') ?>",
                dataType: "json",
                async: false,
                data: $(this).serialize(),
