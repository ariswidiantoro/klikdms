...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url('master_finance/saveDepartement'); ?>" name="formAdd">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="50" style='text-transform:uppercase' 
                   name="dept_deskripsi" id="dept_deskripsi"  class="ace col-xs-10 col-sm-10" />
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(this).ready(function() {        
        $('#formAdd').submit(function() {
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('master_finance/saveDepartement') ?>",
                dataType: "json",
                async: false,
                data: $(this).serialize(),
