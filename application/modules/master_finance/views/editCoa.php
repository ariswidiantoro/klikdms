...
<form class="form-horizontal" id="formEdit" method="post" action="<?php echo site_url('master_finance/updateCoa'); ?>" name="formEdit">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <label>
                <input class="ace" id="rugi_laba" value="1" type="checkbox" <?php if ($data['coa_is_rugi_laba'] == '1') echo 'checked'; ?> name="rugi_laba">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <label>
                <input class="ace" id="kas_bank" value="1" type="checkbox" <?php if ($data['coa_is_kas_bank'] == '1') echo 'checked'; ?> name="kas_bank">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <label>
                <input class="ace" id="auto_jurnal" value="1" type="checkbox" <?php if ($data['coa_is_auto_jurnal'] == '1') echo 'checked'; ?> name="auto_jurnal">
