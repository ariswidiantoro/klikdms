...
<script type="text/javascript">
    ...
    function hapusData(id, kode) {
        bootbox.confirm("Yakin Hapus Data "+kode+" ?", function(result) {
            if(result) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('master_finance/deleteDepartement'); ?>',
                    dataType: "json",
                    data: {
                        id: id
                    },
    ...
    $(document).ready(function (){
        jQuery("#grid-table").jqGrid({
            url:'<?php echo site_url('master_finance/loadDepartement') ?>',     
            mtype : "post",            
            datatype: "json",            
...
<div class="row">
    <div class="col-xs-12">
        <p>
            <a href="#master_finance/addDepartement" class="btn btn-sm btn-primary">
                <i class="ace-icon fa fa-plus"></i>
                Tambah Departement</a>
        </p>
