...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url('master_finance/saveSpecialCoa'); ?>" name="formAdd">
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Deskripsi</label>
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="50" name="spec_deskripsi" id="spec_deskripsi"  
...
<script type="text/javascript">
    ...
    $(this).ready(function() {
        $('#formAdd').submit(function() {
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url('master_finance/saveSpecialCoa') ?>",
                dataType: "json",
                async: false,
                data: $(this).serialize(),
