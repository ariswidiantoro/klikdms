<div id="result"></div>
<form class="form-horizontal" id="formRole" method="post" action="<?php echo site_url('master_service/saveFreeService'); ?>" name="formRole">
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Kode Free Service</label>
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="30" style='text-transform:uppercase' name="flat_kode" id="flat_kode" class="ace col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Deskripsi</label>
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="30" style='text-transform:uppercase' name="flat_deskripsi" id="flat_deskripsi" class="ace col-xs-10 col-sm-10" />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="flat_free_jenis" required="required" class="ace col-xs-10 col-sm-3">
                ...
                <option value="1">Free Service Pertama</option>
                <option value="2">Free Service Kedua</option>
                <option value="3">Free Service Ketiga</option>
                <option value="4">> Free Service Ketiga</option>
            </select>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" style="text-align: right" name="flat_part" id="flat_part" 
                   onchange="$('#'+this.id).val(formatDefault(this.value));setTotal()" value="0" placeholder="0" class="number ace col-xs-10 col-sm-3"  />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" style="text-align: right" name="flat_oli" id="flat_oli" 
                   onchange="$('#'+this.id).val(formatDefault(this.value));setTotal()" value="0" placeholder="0" class="number ace col-xs-10 col-sm-3"  />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" style="text-align: right" name="flat_sm" id="flat_sm" 
                   onchange="$('#'+this.id).val(formatDefault(this.value));setTotal()" value="0" placeholder="0" class="number ace col-xs-10 col-sm-3"  />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" style="text-align: right" name="flat_so" id="flat_so" 
                   onchange="$('#'+this.id).val(formatDefault(this.value));setTotal()" value="0" placeholder="0" class="number ace col-xs-10 col-sm-3"  />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" readonly="readonly" style="text-align: right" name="flat_total" id="flat_total" 
