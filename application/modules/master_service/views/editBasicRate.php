...
<form class="form-horizontal" id="formRole" method="post" action="<?php echo site_url('master_service/saveBasicRate'); ?>" name="formRole">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" required="required" style="text-align: right" name="br_rate" value="<?php echo number_format($data['br_rate']) ?>" 
                   id="br_rate" onchange="$('#'+this.id).val(formatDefault(this.value));" placeholder="0" class="number col-xs-10 col-sm-5" />
        </div>
    </div>
