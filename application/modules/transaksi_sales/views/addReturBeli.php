...
<form class="form-horizontal" name="formAdd" method="post" action="" id="formAdd">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">No Retur Beli</label>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Alasan Retur</label>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nomer BMK</label>
        <div class="col-sm-7">
            <input type="text" value="0" required maxlength="30" name="no_bmk" id="no_bmk" class="col-xs-10 col-sm-5 req upper" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nomer Rangka</label>
        <div class="col-sm-7">
            <input type="text" readonly id="rangka" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nomer Mesin</label>
        <div class="col-sm-7">
        ...
        $('#formAdd').submit(function() {
            $.ajax({
                ...
                success: function(data) {
                    window.scrollTo(0, 0);
                    if(data.result){
                        $('.page-content-area').ace_ajax('loadUrl', "#transaksi_sales/addReturBeli", true);
                    }
                    else
