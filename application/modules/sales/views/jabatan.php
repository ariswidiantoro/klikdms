...
<div style="height: 100%;">
    <div id="adv-view">
        <p>
            <a href="<?php echo site_url('administrator/addJabatan') ?>" class="btn btn-small btn-primary">
    ...
    <div id="adv-view1" style="background: #ffffff;">
        ...
        <table id="tt" class="easyui-datagrid" style="height: 450px;" 
               url="<?php echo site_url("administrator/loadJabatan"); ?>"
               title="Data Jabatan" rownumbers="true" striped="true" nowrap="true"
               toolbar="#tb" pagination="true" singleSelect="true">
            <thead>
                <tr>
                    <th field="deskripsi" width="200" sortable="true" >Jabatan</th>
...
<script type="text/javascript">
    ...
    function deleteJabatan(id) {
        if (confirm("Yakin ingin menghapus baris ini ?")) {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('administrator/hapusJabatan'); ?>',
                dataType: "json",
                data: {
                    id: id
                },
                success: function(data) {
                    if (data) {
                        window.location.href = '<?php echo site_url('administrator/jabatan') ?>';
                    } else {
