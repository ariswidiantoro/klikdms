<div id="result"></div>
<form class="form-horizontal" id="form" method="post" action="<?php echo site_url('master_sparepart/saveInventory'); ?>" name="form">
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Kode Barang</label>
        <div class="col-sm-8">
            <input type="text" required="required" name="inve_kode" placeholder="Kode Barang" maxlength="40" class="upper col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Nama Barang</label>
        <div class="col-sm-8">
            <input type="text" required="required" name="inve_nama" placeholder="Nama Barang" maxlength="60" class="upper col-xs-10 col-sm-10" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Barcode</label>
        <div class="col-sm-8">
            <input type="text" name="inve_barcode" placeholder="Barcode" maxlength="40" class="upper col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" required="required" id="inve_harga" onchange="$('#'+this.id).val(formatDefault(this.value))" name="inve_harga" placeholder="0" maxlength="60" class="number col-xs-10 col-sm-3" /> * Harga Include PPN
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Stock Minimum</label>
        <div class="col-sm-8">
            <input type="text" name="inve_qty_min" placeholder="0" maxlength="60" class="number col-xs-10 col-sm-2" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Usia Dalam KM</label>
        <div class="col-sm-8">
            <input type="text" name="inve_umur_km" placeholder="0" maxlength="60" class="number col-xs-10 col-sm-2" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Usia Dalam Bulan</label>
        <div class="col-sm-8">
            <input type="text" name="inve_umur_bulan" placeholder="0" maxlength="60" class="number col-xs-10 col-sm-2" />
        </div>
    </div>
