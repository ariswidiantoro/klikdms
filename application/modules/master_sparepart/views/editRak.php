<div id="result"></div>
<form class="form-horizontal" id="form" method="post" action="<?php echo site_url('master_sparepart/updateRak'); ?>" name="form">
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Nama Rak</label>
        <div class="col-sm-8">
            <input type="hidden" value="<?php echo $data['rakid'] ?>" name="rakid">
            <input type="text" name="rak_deskripsi" required="required" value="<?php echo $data['rak_deskripsi'] ?>" id="rak_deskripsi" placeholder="Nama Rak" class="upper col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
