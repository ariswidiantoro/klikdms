...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url($etc['targetSave']); ?>" name="formAdd">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="30" style='text-transform:uppercase' name="trans_docno" id="trans_docno" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-left" for="form-field-1">Tanggal</label>
        <div class="col-sm-8">
            <input type="text" required="required" maxlength="50" style='text-transform:uppercase' name="trans_date" id="trans_date"  class="ace col-xs-10 col-sm-10" />
        </div>
    </div>
    <div class="form-group">
