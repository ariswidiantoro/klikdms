...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url($etc['targetSave']); ?>" name="formAdd">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
             <input type="text" id="trans_desc" name="trans_desc" required="required" maxlength="500" class="upper form-control input-xlarge req" />
             <a href="#master_service/addPelanggan?href=transaksi_finance/addUangMuka" class="btn btn-sm btn-primary">
                <i class="ace-icon fa fa-plus"></i>
                Tambah Pelanggan</a>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-left" for="form-field-1">Sebesar</label>
        <div class="col-sm-8">
             <input type="text" id="trans_desc" name="trans_total" required="required" 
                    onchange="$('#'+this.id).val(formatCurrency(this.value));" class="number form-control input-xlarge req" />
        </div>
    </div>
    <div class="form-group">
