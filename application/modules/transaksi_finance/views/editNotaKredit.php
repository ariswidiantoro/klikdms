...
<form class="form-horizontal" id="formAdd" method="post" action="<?php echo site_url($etc['targetSave']); ?>" name="formAdd">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            ...
            <input type="hidden" id="trans_kstid" name="trans_kstid" value="<?php echo $main['kstid']; ?>" />
            <input type="hidden" id="trans_purpose" name="trans_purpose" value="<?php echo $etc['purpose']; ?>" />
            <input type="hidden" id="trans_trans" name="trans_trans" value="<?php echo $main['trans']; ?>" />
            <input type="hidden" id="trans_sub_trans" name="trans_sub_trans" value="<?php echo $main['kst_subtrans']; ?>" />
            <input type="hidden" id="trans_type" name="trans_type" value="<?php echo $main['kst_type']; ?>" />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <input type="text" id="trans_tgl" name="trans_tgl" readonly="readonly" 
                       value="<?php echo date('d-m-Y', strtotime($main['kst_tgl'])); ?>" 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" id="dtrans_kontrak" name="dtrans_kontrak[]" readonly maxlength="50" value="<?php echo $detail[0]['dkst_kontrak'];?>" 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" id="dtrans_pelname" name="dtrans_pelname[]" readonly maxlength="50" value="<?php echo $detail[0]['dkst_kontrak'];?>" 
                   class="req upper form-control input-xlarge" />
            <input type="hidden" id="dtrans_pelid" name="dtrans_pelid[]" value="<?php echo $detail[0]['dkst_pelid'];?>"/>
        </div>
    </div>
    <div class="form-group">
