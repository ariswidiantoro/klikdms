...
{	
	function Excel($params)
	{
		...
		$this->CI->load->view($php_page, $data);	
	}
	function setHeader($excel_file_name)//this function used to set the header variable
	{		
		header("Content-type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");//A MIME attachment with the content type "application/octet-stream" is a binary file.
